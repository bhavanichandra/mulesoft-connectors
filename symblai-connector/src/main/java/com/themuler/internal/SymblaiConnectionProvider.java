 ...
 */
public class SymblaiConnectionProvider implements PoolingConnectionProvider<SymblaiConnection> {

  private final Logger LOGGER = LoggerFactory.getLogger(SymblaiConnectionProvider.class);
  ...
  */
  ...
  public SymblaiConnection connect() throws ConnectionException {
    return new SymblaiConnection(requiredParameter + ":" + optionalParameter);
  }
